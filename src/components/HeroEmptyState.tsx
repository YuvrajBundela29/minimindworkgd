...
const SUGGESTED_PROMPTS = [
  { emoji: '🤖', text: 'How does AI actually work?' },
  { emoji: '📈', text: 'Explain stock market like I\'m 10' },
  { emoji: '🌌', text: 'Why do black holes exist?' },
  { emoji: '🧬', text: 'What is DNA and why is it important?' },
  { emoji: '💡', text: 'How does electricity power our homes?' },
  { emoji: '🌍', text: 'Why is climate change happening?' },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 px-1 -mx-1 custom-scrollbar snap-x snap-mandatory">
          {SUGGESTED_PROMPTS.map((prompt, index) => (
            <motion.button
              ...
              className="flex-shrink-0 snap-start group flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border/50 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all min-w-[200px] text-left"
            >
